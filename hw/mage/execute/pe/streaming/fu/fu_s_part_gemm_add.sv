...
//
// File: fu_s_part_gemm.sv
// Author: Alessio Naclerio
// Date: 26/02/2025
// Description: FU for streaming mode supporting int32/int16/int8 computation of classic gemm-related operations

module fu_s_part_gemm_add
  import pea_pkg::*;
(
    input  logic                   clk_i,
    input  logic                   rst_n_i,
  ...
  */
  ...
  assign part_op_instr = (instr_i == ADD) ? 2'b00 :
                    (instr_i == SUB) ? 2'b01 :
                    (instr_i == ACC) ? 2'b10 :
                    2'b00;
