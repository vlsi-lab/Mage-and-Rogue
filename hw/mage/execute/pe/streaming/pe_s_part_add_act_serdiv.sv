...
//
// File: pe_s_part_add_act_serdiv.sv
// Author: Alessio Naclerio
// Date: 26/02/2025
// Description: PE for streaming mode supporting int32/int16/int8 mul and int32 computation of classic gemm-related operations and activations with serial divider

module pe_s_part_add_act_serdiv
  import pea_pkg::*;
(
    input  logic                                 clk_i,
    input  logic                                 rst_n_i,
...
`endif
  ...
  */
  ...
  //                         Functional Unit                    //
  ////////////////////////////////////////////////////////////////
  fu_s_part_add_act_serdiv fu_s_part_add_act_serdiv_i (
      .clk_i(clk_cg),
      .rst_n_i(rst_n_i),
      .mage_done_i,
