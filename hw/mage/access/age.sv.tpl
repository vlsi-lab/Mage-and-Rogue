...
% if kernel_len != 1:
  ...
  logic [1:0][NBIT_LP_IV-1:0] iv_const_1;

  // Stage 2 cfg from instruction word
  logic [2:0][NBIT_N_BANKS-1:0] n_banks_2;
  logic [2:0][NBIT_START_BANK-1:0] start_bank_2;
  logic [2:0][NBIT_BLOCK_SIZE-1:0] block_size_2;
  logic [2:0] stream_lns_2;
  logic [2:0] is_acc_store_2;
%else:
  ////////////////////////////////
